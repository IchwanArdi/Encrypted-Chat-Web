  ...
  return (
    <>
      <SEO
        ...
        type="website"
        additionalMetaTags={[
          { name: 'theme-color', content: '#9333ea' }, // ungu vibe register
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    disabled={isLoading}
                  />
                  <button type="button" className="absolute inset-y-0 right-0 pr-4 flex items-center" onClick={() => setShowPassword(!showPassword)} disabled={isLoading}>
                ...
                <p className="mt-2 text-xs text-gray-400 font-medium">Minimum 3 characters</p>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    disabled={isLoading}
                  />
                  <button type="button" className="absolute inset-y-0 right-0 pr-4 flex items-center" onClick={() => setShowConfirmPassword(!showConfirmPassword)} disabled={isLoading}>
                    <svg className="h-5 w-5 text-gray-400 hover:text-gray-300 transition-colors duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      {showConfirmPassword ? (
                        <path
                          strokeLinecap="round"
