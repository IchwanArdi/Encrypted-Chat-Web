                  ...
                  <div className="space-y-2">
                    {userList.map((chatUser) => (
                      ...
                      >
                        ...
                        {unreadMessages.get(chatUser.id) > 0 && (
                          <div className="min-w-[18px] h-4 bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-full flex items-center justify-center text-xs font-bold animate-pulse shadow-lg">{unreadMessages.get(chatUser.id)}</div>
                        )}
                      </button>
                    ))}
                    {userList.length === 0 && (
